...
wb = openpyxl.load_workbook('Assignment_3_ results-arijit.xlsx')
...
print ("***** Write Xp[3] XL")
for i in (range (alen(Mu))):
    sheet.cell(row=74, column=(2+i)).value = X[1][i]

print ("***** Write Zp[3] XL")
for i in (range (alen(Mu))):
    sheet.cell(row=75, column=(2+i)).value = Z[1][i]

print ("***** Write Pp[3] XL")
for i in (range (len(P[3]))):
    sheet.cell(row=76, column=(2+i)).value = P[1][i]

print ("***** Write Rp[3] XL")
for i in (range (alen(Mu))):
    sheet.cell(row=77, column=(2+i)).value = R[1][i]

print ("***** Write Xrec2p[3] XL")
for i in (range (alen(Mu))):
    sheet.cell(row=78, column=(2+i)).value = Xrec2[1][i]
...
#    
wb.save('Assignment_3_ results-arijit.xlsx')
